...
class TodoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.createTodos = channel.stream_unary(
                '/todoPackage.Todo/createTodos',
                request_serializer=todo__pb2.TodoItem.SerializeToString,
                response_deserializer=todo__pb2.TodoItems.FromString,
                )
        self.readTodos = channel.unary_stream(
...
class TodoServicer(object):
    ...
    def createTodos(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_TodoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'createTodos': grpc.stream_unary_rpc_method_handler(
                    servicer.createTodos,
                    request_deserializer=todo__pb2.TodoItem.FromString,
                    response_serializer=todo__pb2.TodoItems.SerializeToString,
            ),
            'readTodos': grpc.unary_stream_rpc_method_handler(
                    servicer.readTodos,
...
class Todo(object):
    ...
    @staticmethod
    def createTodos(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/todoPackage.Todo/createTodos',
            todo__pb2.TodoItem.SerializeToString,
    ...
    def readTodos(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/todoPackage.Todo/readTodos',
